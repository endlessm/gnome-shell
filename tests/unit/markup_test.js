...
describe ('Markup Fixer', function() {
    ...
    function convertAndEscape(text) {
        const conversion = MessageListMarkup.fixMarkup(text, true);
        const escape = MessageListMarkup.fixMarkup(text, false);
        return {
    ...
    it ('converts and escapes non-nested bold italic and underline markup', function() {
    ...
    it ('converts and escapes angle brackets within HTML markup', function() {
    ...
    it ('converts and escapes a stray <', function() {
        const text = 'this < that';
        const result = convertAndEscape(text);
