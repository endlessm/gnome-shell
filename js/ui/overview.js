...
const { Clutter, GLib, Meta, Pango, Shell, St } = imports.gi;
...
var NoWindowsDialog = class extends ModalDialog.ModalDialog {
    constructor() {
        ...
        this._group.connect('key-press-event', (event) => {
    ...
    show() {
        ...
        this._timeoutId =
            Mainloop.timeout_add(NO_WINDOWS_OPEN_DIALOG_TIMEOUT, () => {
                this.hide();
