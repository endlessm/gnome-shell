...
var ViewsDisplayContainer = new Lang.Class({
...
var ViewsDisplay = new Lang.Class({
    Name: 'ViewsDisplay',
    ...
    _enterSearch: function() {
        ...
        this._enterSearchTimeoutId = Mainloop.timeout_add(SEARCH_ACTIVATION_TIMEOUT, () => {
            this._enterSearchTimeoutId = 0;
            this.actor.showPage(ViewsDisplayPage.SEARCH, true);
...
var ViewsDisplayConstraint = new Lang.Class({
