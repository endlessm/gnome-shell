...
const EOS_PAYG_NAME = 'com.endlessm.Payg';
const EOS_PAYG_PATH = '/com/endlessm/Payg';

const EOS_PAYG_IFACE = '<node> \
<interface name="com.endlessm.Payg"> \
<method name="AddCode"> \
...
var PaygManager = new Lang.Class({
    ...
    _setEnabled: function(value) {
        this._paygEnabled = value;
        this.emit('payg-enabled', this._paygEnabled);
    },

    _setExpiryTime: function(value) {
        this._expiryTime = value;
        this.emit('payg-expiry-time-changed', this._expiryTime);
    },

    _onCodeExpired: function(proxy) {
        this.emit('payg-code-expired');
    },
    ...
    enable: function() {
        if (!this._proxy) {
            ...
            this._proxy.init_async(GLib.PRIORITY_DEFAULT, null, (object, res) => {
                try {
                    object.init_finish (res);
                } catch (e) {
                    logError(e, "Error while constructing DBus proxy for " + EOS_PAYG_NAME);
                    return;
                }
    ...
    addCode: function(code) {
        this.proxy.AddCodeRemote(code);
    },

    clearCode: function() {
        this.proxy.ClearCodeRemote();
    },

    get paygEnabled() {
        return this._paygEnabled;
    },
