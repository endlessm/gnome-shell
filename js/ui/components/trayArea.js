...
var TrayArea = new Lang.Class({
    ...
    _updateIconStyle: function(icon) {
        // Size
    ...
    _onTrayIconAdded: function(o, icon, role, delay=1000) {
        ...
        let iconContainer = new St.Button({ child: icon,
                                            visible: false });
    ...
    _createTray: function() {
        ...
        this._trayManager.manage_screen(global.screen, Main.panel.actor);
        ...
        this._targetPanel.insert_child_at_index(this._iconsContainer.actor, 0);
