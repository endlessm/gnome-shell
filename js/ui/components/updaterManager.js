...
var UpdaterNotification = class extends MessageTray.Notification {
...
var UpdaterManager = class {
    constructor() {
        this._proxy = new UpdaterProxy(Gio.DBus.system, 'com.endlessm.Updater',
                                       '/com/endlessm/Updater', this._onProxyConstructed.bind(this));
    ...
    _notifyUpdateAvailable() {
        ...
        this._notification.addAction(_("Download Now"), () => {
            this._notification.destroy();
    ...
    _notifyUpdateReady() {
        ...
        this._notification.addAction(_("Install Now"), () => {
            this._notification.destroy();
    ...
    _notifyUpdateApplied() {
        this._ensureSource();

        this._notification = new UpdaterNotification(this._source,
            _("Updates Installed"),
            _("Software updates were installed on your system"));
        this._notification.addAction(_("Restart Now"), () => {
            this._notification.destroy();
