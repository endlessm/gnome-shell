...
var NetworkSecretDialog = class extends ModalDialog.ModalDialog {
    constructor(client, agent, requestId, connection, settingName, hints, flags, contentOverride) {
    ...
    _addMeteredConnectionToggle(connection, layout, position) {
...
var NetworkAgent = class {
    ...
    _handleRequest(requestId, connection, settingName, hints, flags) {
        ...
        let dialog = new NetworkSecretDialog(this._client, this._native, requestId, connection, settingName, hints, flags);
