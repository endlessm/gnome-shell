...
const { AnimationsDbus, Clutter, EndlessShellFX,
        Gdk, Gio, GLib,
...
var WindowManager = class {
    ...
    _windowGrabbed(display, screen, win, op) {
        ...
        if (!this._windowCanWobble(win, op))
            return;
    ...
    _windowUngrabbed(display, op, win) {
