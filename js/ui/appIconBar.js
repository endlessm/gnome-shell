...
const WindowMenuItem = class extends PopupMenu.PopupBaseMenuItem {
...
const ScrollMenuItem = class extends PopupMenu.PopupSubMenuMenuItem {
    constructor() {
        super('');
...
const AppIconButton = GObject.registerClass({
    ...
    _init(app, iconSize, menuManager, allowsPinning) {
        // FIXME: this is still required by GrabHelper (which is
        // used by PopupMenu.PopupMenuManager)
        this.actor = this;
        ...
        super._init({ style_class: 'app-icon-button',
                      child: icon,
