                                            ...
                                            ShellApp       *app)
{
  ...
  switch (state)
    ...
    case SHELL_APP_STATE_RUNNING:
      if (app_info_id != NULL &&
          !g_hash_table_contains (self->aggregate_timers, app_info_id))
        {
          ...
          g_hash_table_insert (self->aggregate_timers,
    ...
    case SHELL_APP_STATE_STOPPED:
      if (g_hash_table_remove (self->running_apps, app) && app_info_id != NULL)
        g_hash_table_remove (self->aggregate_timers, app_info_id);
      break;
    default:
      g_warn_if_reached();
      break;
